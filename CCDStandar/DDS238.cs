...
namespace CCDStandar
{
    public class DDS238
    {
        ...
        public DDS238(bool muestraDatosConsola, SerialPortInterface serial, string ip, int puerto, bool esSocket,bool escribeArchivoLog, string path)
        {
            _path = path;
            _esSocket = esSocket;
            ...
            if (_escribeArchivoLog)
            {
                ...
                _f = System.IO.File.AppendText(Path.Combine(_path, log));
            }
        }
